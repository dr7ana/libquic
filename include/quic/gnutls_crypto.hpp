...
namespace oxen::quic
{
    ...
    class GNUTLSCreds : public TLSCreds
    {
      ...
      public:
        /*
         * gnutls debug variables, left here for convenience until confident the gnutls stuff is all working
         *
        static bool gnutls_debug_initialized;

        static void init_gnutls_debug();
         *
         */

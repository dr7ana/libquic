...
namespace oxen::quic
{
    ...
    class Network
    {
      ...
      public:
		...
		std::shared_ptr<Endpoint> endpoint(Address& local_addr);
      ...
      private:
        ...
        std::map<Address, std::shared_ptr<Endpoint>, addr_comparator> endpoint_map;
        std::map<Address, std::shared_ptr<uv_udp_t>, addr_comparator> handle_map;
